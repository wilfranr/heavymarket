 ...
 * Selector de loading
 */
export const selectTRMsLoading = createSelector(selectTRMsState, (state: TRMsState) => state.loading);

/**
 * Selector de error
 */
export const selectTRMsError = createSelector(selectTRMsState, (state: TRMsState) => state.error);
 ...
 */
export const selectLatestTRM = createSelector(selectTRMsState, (state: TRMsState) => state.latestTRM);

/**
 * Selector de TRM por ID
 */
export const selectTRMById = (id: number) => createSelector(selectTRMsEntities, (entities) => entities[id] || null);
