 ...
 * Selector de loading
 */
export const selectEmpresasLoading = createSelector(selectEmpresasState, (state: EmpresasState) => state.loading);

/**
 * Selector de error
 */
export const selectEmpresasError = createSelector(selectEmpresasState, (state: EmpresasState) => state.error);
 ...
 */
export const selectEmpresaById = (id: number) => createSelector(selectEmpresasEntities, (entities) => entities[id] || null);

/**
 * Selector de empresas activas
 */
export const selectEmpresasActivas = createSelector(selectAllEmpresas, (empresas) => empresas.filter((empresa) => empresa.estado === true));
