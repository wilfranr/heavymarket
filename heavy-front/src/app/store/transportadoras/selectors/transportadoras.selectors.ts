 ...
 * Selector de loading
 */
export const selectTransportadorasLoading = createSelector(selectTransportadorasState, (state: TransportadorasState) => state.loading);

/**
 * Selector de error
 */
export const selectTransportadorasError = createSelector(selectTransportadorasState, (state: TransportadorasState) => state.error);
 ...
 */
export const selectTransportadoraById = (id: number) => createSelector(selectTransportadorasEntities, (entities) => entities[id] || null);
