 ...
 */
export const loadTerceros = createAction('[Terceros] Load Terceros', props<{ params?: any }>());

export const loadTercerosSuccess = createAction('[Terceros] Load Terceros Success', props<{ terceros: Tercero[] }>());

export const loadTercerosFailure = createAction('[Terceros] Load Terceros Failure', props<{ error: any }>());
...
export const createTerceroFailure = createAction('[Terceros] Create Tercero Failure', props<{ error: any }>());
...
export const updateTerceroFailure = createAction('[Terceros] Update Tercero Failure', props<{ error: any }>());

/**
 * Acciones para eliminar tercero
 */
export const deleteTercero = createAction('[Terceros] Delete Tercero', props<{ id: number }>());
