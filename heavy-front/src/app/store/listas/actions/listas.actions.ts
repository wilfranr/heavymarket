...
// Cargar listas
export const loadListas = createAction('[Listas] Load Listas', props<{ tipo?: ListaTipo; search?: string; page?: number; per_page?: number; sort_by?: string; sort_order?: 'asc' | 'desc' }>());
