...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, RouterModule, CardModule, ButtonModule, TagModule, DividerModule, SkeletonModule, ToastModule, DialogModule, TooltipModule, MaquinaDetailComponent],
