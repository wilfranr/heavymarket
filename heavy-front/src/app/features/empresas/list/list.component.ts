...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, RouterModule, TableModule, ButtonModule, InputTextModule, TagModule, ConfirmDialogModule],
            ...
            <div class="mb-4">
                <div class="flex justify-content-between mb-3">
                    ...
                    <div class="flex gap-2">
                        <p-button label="Nueva Empresa" icon="pi pi-plus" (onClick)="onCreateEmpresa()"> </p-button>
                    </div>
                </div>
            </div>

            <!-- Tabla de Empresas -->
            <p-table [value]="empresas()" [loading]="loading()" [paginator]="true" [rows]="15" [totalRecords]="total()" styleClass="p-datatable-gridlines">
                ...
                <ng-template pTemplate="body" let-empresa>
                    <tr>
                        ...
                        <td>
                            <p-button icon="pi pi-eye" [rounded]="true" [text]="true" severity="info" (onClick)="onViewEmpresa(empresa.id)"> </p-button>
                            <p-button icon="pi pi-pencil" [rounded]="true" [text]="true" severity="warn" (onClick)="onEditEmpresa(empresa.id)"> </p-button>
                            <p-button icon="pi pi-trash" [rounded]="true" [text]="true" severity="danger" (onClick)="onDeleteEmpresa(empresa)"> </p-button>
                        </td>
                    </tr>
                </ng-template>
            </p-table>
