      ...
      <p-table
        ...
        <ng-template pTemplate="body" let-direccion>
          <tr>
            ...
            <td>
              <p-tag
                [value]="direccion.principal ? 'Sí' : 'No'"
                [severity]="direccion.principal ? 'success' : 'secondary'">
              </p-tag>
            </td>
            <td>
              <p-button
                ...
                [text]="true"
                severity="info"
                (onClick)="onViewDireccion(direccion.id)">
              </p-button>
              <p-button
                icon="pi pi-pencil"
                [rounded]="true"
                [text]="true"
                severity="warn"
                (onClick)="onEditDireccion(direccion.id)">
              </p-button>
              <p-button
                icon="pi pi-trash"
                [rounded]="true"
