      ...
      <div class="mb-4">
        <div class="flex justify-content-between mb-3">
          ...
          <div class="flex gap-2">
            <p-button
              label="Nueva Transportadora"
              icon="pi pi-plus"
              (onClick)="onCreateTransportadora()">
            </p-button>
          </div>
        </div>
      </div>
          ...
          <tr>
            ...
            <td>
              <p-button
                ...
                [text]="true"
                severity="info"
                (onClick)="onViewTransportadora(transportadora.id)">
              </p-button>
              <p-button
                icon="pi pi-pencil"
                [rounded]="true"
                [text]="true"
                severity="warn"
                (onClick)="onEditTransportadora(transportadora.id)">
              </p-button>
              <p-button
                icon="pi pi-trash"
                [rounded]="true"
                [text]="true"
                severity="danger"
                (onClick)="onDeleteTransportadora(transportadora)">
              </p-button>
            </td>
          </tr>
        </ng-template>
