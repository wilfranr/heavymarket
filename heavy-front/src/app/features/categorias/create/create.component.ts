            ...
            <form [formGroup]="categoriaForm" (ngSubmit)="onSubmit()">
                <div class="grid">
                    ...
                    <div class="col-12">
                        ...
                        <p-multiSelect formControlName="terceros" [options]="proveedores" placeholder="Seleccione proveedores (opcional)" optionLabel="label" optionValue="value" [filter]="true" [showClear]="true" styleClass="w-full"> </p-multiSelect>
                    </div>
                </div>

                <div class="flex justify-content-end gap-2 mt-4">
                    <p-button label="Cancelar" severity="secondary" icon="pi pi-times" type="button" [outlined]="true" (onClick)="onCancel()"> </p-button>
                    <p-button label="Crear Categoría" icon="pi pi-check" type="submit" [loading]="loading" [disabled]="categoriaForm.invalid"> </p-button>
                </div>
            </form>
        </div>
        <p-toast></p-toast>
