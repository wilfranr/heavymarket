        ...
        <div class="grid">
          ...
          <div class="col-12 md:col-6">
            ...
            <p-select
              ...
              placeholder="Seleccione una cotización (opcional)"
              [filter]="true"
              [showClear]="true"
              styleClass="w-full">
            </p-select>
          ...
          <div class="col-12 md:col-6">
            <label for="fecha_ingreso" class="block mb-2">
          ...
          <div class="col-12 md:col-6">
            ...
            <p-select
              formControlName="transportadora_id"
              [options]="transportadoras"
              placeholder="Seleccione una transportadora (opcional)"
              [filter]="true"
              [showClear]="true"
              styleClass="w-full">
            </p-select>
