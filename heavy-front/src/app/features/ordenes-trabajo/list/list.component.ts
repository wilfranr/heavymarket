            ...
            <div class="mb-4">
                <div class="flex justify-content-between mb-3">
                    ...
                    <div class="flex gap-2">
                        ...
                        <p-button label="Nueva Orden" icon="pi pi-plus" (onClick)="onCreateOrdenTrabajo()"> </p-button>
                    </div>
                </div>
            </div>

            <!-- Tabla de Órdenes de Trabajo -->
            <p-table [value]="ordenesTrabajo()" [loading]="loading()" [paginator]="true" [rows]="15" [totalRecords]="total()" styleClass="p-datatable-gridlines">
                ...
                <ng-template pTemplate="body" let-orden>
                    <tr>
                        ...
                        <td>
                            <p-button icon="pi pi-eye" [rounded]="true" [text]="true" severity="info" (onClick)="onViewOrdenTrabajo(orden.id)"> </p-button>
                            <p-button icon="pi pi-pencil" [rounded]="true" [text]="true" severity="warn" (onClick)="onEditOrdenTrabajo(orden.id)"> </p-button>
                            <p-button icon="pi pi-trash" [rounded]="true" [text]="true" severity="danger" (onClick)="onDeleteOrdenTrabajo(orden)"> </p-button>
                        </td>
                    </tr>
                </ng-template>
            </p-table>
