        ...
        <div class="card">
            ...
            <form [formGroup]="cotizacionForm" (ngSubmit)="onSubmit()">
                <div class="grid">
                    ...
                    <div class="col-12 md:col-6">
                        <label for="tercero_id" class="block mb-2"> Cliente <span class="text-red-500">*</span> </label>
                        <p-select formControlName="tercero_id" [options]="terceros" placeholder="Seleccione un cliente" [filter]="true" [showClear]="true" styleClass="w-full"> </p-select>
                ...
                <div class="flex justify-content-end gap-2 mt-4">
                    ...
                    <p-button label="Crear Cotización" icon="pi pi-check" type="submit" [loading]="loading" [disabled]="cotizacionForm.invalid"> </p-button>
                </div>
            </form>
        </div>
        <p-toast></p-toast>
