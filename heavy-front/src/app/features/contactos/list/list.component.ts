            ...
            <div class="mb-4">
                <div class="flex justify-content-between mb-3">
                    ...
                    <div class="flex gap-2">
                        <p-button label="Nuevo Contacto" icon="pi pi-plus" (onClick)="onCreateContacto()"> </p-button>
                    </div>
                </div>
            </div>

            <!-- Tabla de Contactos -->
            <p-table [value]="contactos()" [loading]="loading()" [paginator]="true" [rows]="15" [totalRecords]="total()" styleClass="p-datatable-gridlines">
                ...
                <ng-template pTemplate="body" let-contacto>
                    <tr>
                        ...
                        <td>
                            <p-tag [value]="contacto.principal ? 'Sí' : 'No'" [severity]="contacto.principal ? 'success' : 'secondary'"> </p-tag>
                        </td>
                        <td>
                            <p-button icon="pi pi-eye" [rounded]="true" [text]="true" severity="info" (onClick)="onViewContacto(contacto.id)"> </p-button>
                            <p-button icon="pi pi-pencil" [rounded]="true" [text]="true" severity="warn" (onClick)="onEditContacto(contacto.id)"> </p-button>
                            <p-button icon="pi pi-trash" [rounded]="true" [text]="true" severity="danger" (onClick)="onDeleteContacto(contacto)"> </p-button>
                        </td>
                    </tr>
                </ng-template>
            </p-table>
