...
export class EditComponent implements OnInit {
  ...
  private initForm(ordenCompra: any): void {
    this.ordenCompraForm = this.fb.group({
      ...
      fecha_expedicion: [
        ordenCompra.fecha_expedicion ? new Date(ordenCompra.fecha_expedicion).toISOString().split('T')[0] : null,
      ],
      fecha_entrega: [
        ordenCompra.fecha_entrega ? new Date(ordenCompra.fecha_entrega).toISOString().split('T')[0] : null,
      ],
  ...
  onSubmit(): void {
    ...
    const data: UpdateOrdenCompraDto = {
      ...
      fecha_expedicion: formValue.fecha_expedicion
        ? new Date(formValue.fecha_expedicion).toISOString().split('T')[0]
        : undefined,
