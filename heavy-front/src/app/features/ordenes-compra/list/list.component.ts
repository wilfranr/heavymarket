    ...
    <div class="card">
      ...
      <p-table
        ...
        <ng-template pTemplate="body" let-orden>
          <tr>
            <td>OC-{{ orden.id }}</td>
            <td>{{ orden.proveedor?.razon_social || orden.proveedor?.nombre_comercial || 'N/A' }}</td>
            ...
            <td>
              <div
                [style.background-color]="orden.color || '#FFFF00'"
                [style.width]="'20px'"
                [style.height]="'20px'"
            ...
            <td>
              <p-button
                ...
                [text]="true"
                severity="info"
                (onClick)="onViewOrdenCompra(orden.id)">
              </p-button>
              <p-button
                icon="pi pi-pencil"
                [rounded]="true"
                [text]="true"
                severity="warn"
                (onClick)="onEditOrdenCompra(orden.id)">
              </p-button>
              <p-button
                icon="pi pi-trash"
                [rounded]="true"
                [text]="true"
                severity="danger"
                (onClick)="onDeleteOrdenCompra(orden)">
              </p-button>
            </td>
          </tr>
        </ng-template>
