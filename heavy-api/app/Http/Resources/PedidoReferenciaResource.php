 ...
 *
 * @property PedidoReferencia $resource
 */
class PedidoReferenciaResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'categoria_comercial_ids' => $this->categoriasComerciales->pluck('id'),
            'marca_id' => $this->marca_id,
            'definicion' => $this->definicion,
            'cantidad' => $this->cantidad,
            'comentario' => $this->comentario,
            'comentarios_count' => $this->resource->comentariosRegistrosCount(),
            'imagen' => $imagenUrl,
            'imagenes_count' => $this->resource->imagenesRegistrosCount(),
